...
########################################################################################
	...
	Published: 		13/0/2016
	Date Last Ran: 	26/09/2016 00:00
	Version:		1.1.0
...
EXECUTE IMMEDIATE 'TRUNCATE TABLE T_GTT_BOROUGH_LONGEST_SECT_DMA';
EXECUTE IMMEDIATE 'TRUNCATE TABLE T_GTT_BOROUGH_DMA_GREATEST';
execute immediate 'truncate table T_P_DMA_BOROUGH';
COMMIT;
